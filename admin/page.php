  ...
  <nav aria-label="Page navigation">
    <ul class="pagination justify-content-center">
      <?php if ($currentPage > 1) { ?>
        <li class="page-item">
          <a class="page-link" href="admin/browse_cars.php?brand=<?php echo urlencode($brand); ?>&page=<?php echo $currentPage - 1; ?>" aria-label="Previous">
      ...
      <?php for ($page = 1; $page <= $totalPages; $page++) { ?>
        <li class="page-item <?php echo $page == $currentPage ? 'active' : ''; ?>">
          <a class="page-link" href="admin/browse_cars.php?brand=<?php echo urlencode($brand); ?>&page=<?php echo $page; ?>"><?php echo $page; ?></a>
        </li>
      <?php } ?>

      <?php if ($currentPage < $totalPages) { ?>
        <li class="page-item">
          <a class="page-link" href="admin/browse_cars.php?brand=<?php echo urlencode($brand); ?>&page=<?php echo $currentPage + 1; ?>" aria-label="Next">
